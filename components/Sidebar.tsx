...
import { Folder as FolderIcon, Rss, Star, Inbox, Plus, PlaySquare, FileText, X, Trash2, ScanLine, FolderOpen, Search, Sparkles, Menu, ExternalLink, Mail } from 'lucide-react';
        ...
        <div className="p-3 space-y-2">
          <div className="flex gap-2">
            <button
              ...
              className="flex-1 bg-accent hover:bg-accent-muted text-white transition-all rounded-md h-10 md:h-10 min-h-[44px] flex items-center justify-center space-x-2 border-2 border-ink shadow-brutal-sm hover:shadow-brutal hover:-translate-x-0.5 hover:-translate-y-0.5 active:translate-x-0.5 active:translate-y-0.5 active:shadow-none"
            >
            ...
            {onAddNewsletter && (
              <button
                ...
                className="bg-accent hover:bg-accent-muted text-white transition-all rounded-md h-10 md:h-10 min-h-[44px] px-3 flex items-center justify-center border-2 border-ink shadow-brutal-sm hover:shadow-brutal hover:-translate-x-0.5 hover:-translate-y-0.5 active:translate-x-0.5 active:translate-y-0.5 active:shadow-none"
