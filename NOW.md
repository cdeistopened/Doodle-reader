...
|----------|------|--------|
| **High** | Newsletter-to-RSS (Kill the Newsletter) | `doodle-reader-ktn` - See `FEATURE-newsletter-to-rss.md` |
| Medium | Tooltip Spotlight Component | `doodle-reader-bgh` - PRD in `.ralphy/PRD-tooltip.md` |
